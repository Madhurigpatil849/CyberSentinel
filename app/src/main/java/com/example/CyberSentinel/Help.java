...
public class Help extends AppCompatActivity {
    private static final String API_TOKEN = "Bearer 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";
    ...
    private class QueryLLM extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                ...
                jsonInput.put("model", "openai/gpt-3.5-turbo"); // must match OpenRouter model name
